...
var Enemy = /*#__PURE__*/function (_Person) {
  ...
  function Enemy(ctx, x, y, config, imageSrc) {
    ...
    _this = _super.call(this, ctx, x, y, ctx.canvas);
    _this.color = 'red';
    _this.image = new Image();
    _this.image.src = imageSrc;
...
var _default = Enemy;
exports.default = _default;
},{"./Person.js":"js/Person.js"}],"images/player.png":[function(require,module,exports) {
...
var _player = _interopRequireDefault(require("../images/player.png"));

var _enemy = _interopRequireDefault(require("../images/enemy.png"));
...
var Game = /*#__PURE__*/function () {
  function Game() {
    ...
    this.player = new _Player.default(this.ctx, this.canvas.width / 2, this.canvas.height - 48, this.config, _player.default);
  }
  ...
  _createClass(Game, [{
    ...
    value: function update() {
      ...
      if (Math.round(Math.random() * 90) == 1) {
        this.enemies.push(new _Enemy.default(this.ctx, 0, 0, this.config, _enemy.default));
      }
    }
  }, {
    key: "run",
...
},{"./Background.js":"js/Background.js","./Player.js":"js/Player.js","./UI.js":"js/UI.js","./Enemy.js":"js/Enemy.js","../images/player.png":"images/player.png","../images/enemy.png":"images/enemy.png"}],"main.js":[function(require,module,exports) {
"use strict";
